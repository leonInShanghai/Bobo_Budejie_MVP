package cn.bobo.budejie.pro.newpost.presenter;
...
import cn.bobo.budejie.pro.newpost.model.NewpostVideoModel;
 ...
 * 例如：数据解析 等等业务逻辑
 */
public class NewpostVideoPresenter extends BasePresener<NewpostVideoModel> {
    ...
    @Override
    public NewpostVideoModel bingModel() {
